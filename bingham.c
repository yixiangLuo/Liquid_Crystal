...
double hermiteInterpolate(double areaSpacing, double x1, double x2, double y1, double y2, double f11, double f12, double f21, double f22, double f11dx, double f12dx, double f21dx, double f22dx, double f11dy, double f12dy, double f21dy, double f22dy, double x, double y){
	double areaSpacingHalf=areaSpacing/2, areaSpacingSquare=areaSpacing*areaSpacing;
	...
	double fd=f11*alphaX1+f21*alphaX2+f11dx*betaX1+f21dx*betaX2;
	double fu=f12*alphaX1+f22*alphaX2+f12dx*betaX1+f22dx*betaX2;
	double fl=f11*alphaY1+f12*alphaY2+f11dy*betaY1+f12dy*betaY2;
	double fr=f21*alphaY1+f22*alphaY2+f21dy*betaY1+f22dy*betaY2;

	double fddB2=(f21dy-f11dy)/areaSpacing*sepaX1+f11dy;
	double fudB2=(f22dy-f12dy)/areaSpacing*sepaX1+f12dy;
	double fldB1=(f12dx-f11dx)/areaSpacing*sepaY1+f11dx;
	double frdB1=(f22dx-f21dx)/areaSpacing*sepaY1+f21dx;
...
Moments bingham(double* b, binghamDataSpace* binghamDataPointer){
	...
	if(b1>Divide){
		...
		Z=hermiteInterpolate(AreaSpacing_Z, -indexB1*AreaSpacing_Z-AreaSpacing_Z, -indexB1*AreaSpacing_Z, -indexB2*AreaSpacing_Z-AreaSpacing_Z, -indexB2*AreaSpacing_Z, binghamDataPointer->binghamVal_Z[indexB2+1][indexB1+1], binghamDataPointer->binghamVal_Z[indexB2][indexB1+1], binghamDataPointer->binghamVal_Z[indexB2+1][indexB1], binghamDataPointer->binghamVal_Z[indexB2][indexB1], binghamDataPointer->dB1Bingham_Z[indexB2+1][indexB1+1], binghamDataPointer->dB1Bingham_Z[indexB2][indexB1+1], binghamDataPointer->dB1Bingham_Z[indexB2+1][indexB1], binghamDataPointer->dB1Bingham_Z[indexB2][indexB1], binghamDataPointer->dB2Bingham_Z[indexB2+1][indexB1+1], binghamDataPointer->dB2Bingham_Z[indexB2][indexB1+1], binghamDataPointer->dB2Bingham_Z[indexB2+1][indexB1], binghamDataPointer->dB2Bingham_Z[indexB2][indexB1], b1, b2);
    }
	...
	if(b1>Divide){
		indexB1=-(int) (b1/AreaSpacing_Z); indexB2=-(int) (b2/AreaSpacing_Z);
		Z_x12=hermiteInterpolate(AreaSpacing_Z, -indexB1*AreaSpacing_Z-AreaSpacing_Z, -indexB1*AreaSpacing_Z, -indexB2*AreaSpacing_Z-AreaSpacing_Z, -indexB2*AreaSpacing_Z, binghamDataPointer->binghamVal_Z_x12[indexB2+1][indexB1+1], binghamDataPointer->binghamVal_Z_x12[indexB2][indexB1+1], binghamDataPointer->binghamVal_Z_x12[indexB2+1][indexB1], binghamDataPointer->binghamVal_Z_x12[indexB2][indexB1], binghamDataPointer->dB1Bingham_Z_x12[indexB2+1][indexB1+1], binghamDataPointer->dB1Bingham_Z_x12[indexB2][indexB1+1], binghamDataPointer->dB1Bingham_Z_x12[indexB2+1][indexB1], binghamDataPointer->dB1Bingham_Z_x12[indexB2][indexB1], binghamDataPointer->dB2Bingham_Z_x12[indexB2+1][indexB1+1], binghamDataPointer->dB2Bingham_Z_x12[indexB2][indexB1+1], binghamDataPointer->dB2Bingham_Z_x12[indexB2+1][indexB1], binghamDataPointer->dB2Bingham_Z_x12[indexB2][indexB1], b1, b2);
		Z_x22=hermiteInterpolate(AreaSpacing_Z, -indexB2*AreaSpacing_Z-AreaSpacing_Z, -indexB2*AreaSpacing_Z, -indexB1*AreaSpacing_Z-AreaSpacing_Z, -indexB1*AreaSpacing_Z, binghamDataPointer->binghamVal_Z_x12[indexB1+1][indexB2+1], binghamDataPointer->binghamVal_Z_x12[indexB1][indexB2+1], binghamDataPointer->binghamVal_Z_x12[indexB1+1][indexB2], binghamDataPointer->binghamVal_Z_x12[indexB1][indexB2], binghamDataPointer->dB1Bingham_Z_x12[indexB1+1][indexB2+1], binghamDataPointer->dB1Bingham_Z_x12[indexB1][indexB2+1], binghamDataPointer->dB1Bingham_Z_x12[indexB1+1][indexB2], binghamDataPointer->dB1Bingham_Z_x12[indexB1][indexB2], binghamDataPointer->dB2Bingham_Z_x12[indexB1+1][indexB2+1], binghamDataPointer->dB2Bingham_Z_x12[indexB1][indexB2+1], binghamDataPointer->dB2Bingham_Z_x12[indexB1+1][indexB2], binghamDataPointer->dB2Bingham_Z_x12[indexB1][indexB2], b2, b1);
    }
	/* calculating in case 2.2 in the paper. */
	else if (b2>Divide){
	...
	if(b1>Divide){
		indexB1=-(int) (b1/AreaSpacing_Q); indexB2=-(int) (b2/AreaSpacing_Q);
		Q_x12x22=hermiteInterpolate(AreaSpacing_Q, -indexB1*AreaSpacing_Q-AreaSpacing_Q, -indexB1*AreaSpacing_Q, -indexB2*AreaSpacing_Q-AreaSpacing_Q, -indexB2*AreaSpacing_Q, binghamDataPointer->binghamVal_Q_x12x22[indexB2+1][indexB1+1], binghamDataPointer->binghamVal_Q_x12x22[indexB2][indexB1+1], binghamDataPointer->binghamVal_Q_x12x22[indexB2+1][indexB1], binghamDataPointer->binghamVal_Q_x12x22[indexB2][indexB1], binghamDataPointer->dB1Bingham_Q_x12x22[indexB2+1][indexB1+1], binghamDataPointer->dB1Bingham_Q_x12x22[indexB2][indexB1+1], binghamDataPointer->dB1Bingham_Q_x12x22[indexB2+1][indexB1], binghamDataPointer->dB1Bingham_Q_x12x22[indexB2][indexB1], binghamDataPointer->dB2Bingham_Q_x12x22[indexB2+1][indexB1+1], binghamDataPointer->dB2Bingham_Q_x12x22[indexB2][indexB1+1], binghamDataPointer->dB2Bingham_Q_x12x22[indexB2+1][indexB1], binghamDataPointer->dB2Bingham_Q_x12x22[indexB2][indexB1], b1, b2);
    }
	/* calculating in case 2.2 in the paper. */
	else if (b2>Divide){
	...
	/* generate the moment functions corresponding to the original order of b */
	...
	if(BIndex[0]==1 && BIndex[1]==2){
		...
		M.Q_x12x22=- Q_x14 - Q_x12x22 + Q_x12;
	}
	else if(BIndex[0]==3 && BIndex[1]==1){
		M.Q_x12x22=- Q_x12x22 - Q_x24 + Q_x22;
	}
	...
	M.Z=scale*Z;
	M.Z_x12=scale*resortMat[1][0]; M.Z_x22=scale*resortMat[1][1];
	M.Q_x12=resortMat[2][0]; M.Q_x22=resortMat[2][1];
	M.Q_x14=resortMat[3][0]; M.Q_x24=resortMat[3][1];
